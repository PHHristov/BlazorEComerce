...
namespace BlazorEComerce.Server.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<ActionResult<ServiceResponse<bool>>> GetAdminProducts(int id)
        {
        ...
        public async Task<ActionResult<ServiceResponse<ProductSearchResultDTO>>> SearchProduct(string searchText, int page)
        {
